...
import type { Route } from "./+types/examples.neon-fastapi";
...
export function meta({}: Route.MetaArgs) {
  return [
    { title: "FastAPI + GraphQL + Neon Example | Emilio Esposito" },
    {
      name: "description",
      content:
        "Demonstrates using FastAPI with GraphQL and Neon Postgres",
    },
  ];
}
    ...
    <div className="container mx-auto py-10 px-4 md:px-8">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Using FastAPI with GraphQL backend and Neon Postgres
          </CardDescription>
        </CardHeader>
