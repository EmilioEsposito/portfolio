...
async def workspace_read(path: str) -> WorkspaceFile:
    ...
    written here are also visible to the Sernia AI agent on its next run when
    both services point at the same SERNIA_MCP_WORKSPACE_PATH.
