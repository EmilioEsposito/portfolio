...
from apps.api.src.database.database import get_session # Assuming get_session provides DB session
from apps.api.src.utils.clerk import get_auth_user # Import your actual user dependency
from . import service
