...
from apps.api.src.oauth.service import get_oauth_credentials
...
SCOPES = [
    ...
    "https://mail.google.com",  # gmail.send is not enough scope for sending. source: https://stackoverflow.com/questions/19102557/google-oauth-scope-for-sending-mail
...
async def send_email(
    ...
    try:
        ...
        # check if creds has the https://mail.google.com scope
        if "https://mail.google.com" not in credentials.scopes:
            raise HTTPException(
                status_code=400,
                detail="""
                Credentials do not have the https://mail.google.com scope.
                This is required for sending emails unfortunately.
                Please add the scope to the credentials and try again.
                """,
            )
...
def setup_gmail_watch(
    user_id: str = "me",
    topic_name: str = "projects/portfolio-450200/topics/gmail-notifications",
):
    """
