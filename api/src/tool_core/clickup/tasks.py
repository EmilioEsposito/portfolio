...
from api.src.sernia_ai.config import CLICKUP_TEAM_ID
...
async def search_tasks_core(
    ...
    *,
    ...
    Server-side filters narrow the result set; ``query`` then fuzzy-matches
    client-side. Returns formatted task list or JSON.
    """
