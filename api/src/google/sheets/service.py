...
def get_sheets_service():
    ...
    try:
        ...
        raise HTTPException(
            status_code=500, detail=f"Failed to initialize Google Sheets service: {str(e)}"
        )
...
def get_sheet_as_json(spreadsheet_id: str, sheet_name: str = "Sheet1") -> list[dict[str, Any]]:
    ...
    try:
        ...
        raise HTTPException(status_code=500, detail=f"Failed to convert sheet to JSON: {str(e)}")
