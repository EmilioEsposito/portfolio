...
async def save_email_message(
    session: AsyncSession, message_data: dict[str, Any], history_id: int | None = None
...
async def get_email_by_message_id(session: AsyncSession, message_id: str) -> EmailMessage | None:
    """
